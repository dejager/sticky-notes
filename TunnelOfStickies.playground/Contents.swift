...
* mobile device.
* Progam your own shader function in `youMustBeSoOrganized` in Stickies.metal. You
...
do {
  let path = Bundle.main.path(forResource: "Stickies", ofType: "metal")
...
renderer.functionName = "youMustBeSoOrganized"
